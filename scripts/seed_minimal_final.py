...
def main():
    try:
        ...
        print("\n[4/7] Inserting Users...")
        users_data = [
            ('admin', 'admin@rdios.com', 'Admin', 'User', 'admin123', 'superadmin', None),
            ('manager1', 'manager@rdios.com', 'Manager', 'One', 'manager123', 'manager', outlet_ids[0]),
            ('analyst1', 'analyst@rdios.com', 'Analyst', 'One', 'analyst123', 'analyst', None),
            ('staff1', 'staff@rdios.com', 'Staff', 'One', 'staff123', 'staff', outlet_ids[0]),
        ]
        ...
        for username, email, fname, lname, password, role_name, outlet_id in users_data:
            ...
            print(f"   ✓ Created user: {user[1]} (ID: {user_id}, Role: {role_name})")
            ...
            if outlet_id:
                cur.execute("""
                    ...
                    VALUES (%s, %s)
                """, (user_id, outlet_id))
                print(f"     └─ Associated user with Outlet ID: {outlet_id}")
