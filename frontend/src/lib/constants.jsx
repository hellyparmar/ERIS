...
export const TRANSLATIONS = {
    en: {
        ...
        dashboard: {
            title: 'Dashboard',
            subtitle: 'ERIS — Enterprise Retail Intelligence System',
...
export const CHART_COLORS = {
    primary: '#0d9488',      // Forest Green
    secondary: '#3b82f6',    // Deep Blue
    success: '#0d9488',      // Forest Green
    warning: '#0d9488',      // Amber
    danger: '#ef4444',       // Red
    info: '#3b82f6',         // Deep Blue
    grid: 'rgba(0,0,0,0.06)',
    gridLight: 'rgba(0,0,0,0.03)'
};
...
export const APP_CONFIG = {
    name: 'ERIS — Enterprise Retail Intelligence System',
    version: '3.0.0',
    author: 'ERIS Team',
    defaultLanguage: 'en',
