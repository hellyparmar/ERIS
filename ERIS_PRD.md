...
- **`gen_notebook.py`** (root): intentionally kept pending Prompt 3 (notebook regeneration task). Contains the logic to rebuild `research/notebooks/model_comparison.ipynb`. Delete only after that notebook is regenerated and committed.
