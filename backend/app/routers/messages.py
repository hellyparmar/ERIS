...
from app.models import MessageChannel, User
...
class SendMessageRequest(BaseModel):
    ...
    channel: str = Field(default="in_app", description="email, sms, in_app")
...
def get_inbox(
    ...
    - Filter by channel (email, sms, in_app)
    - Pagination support
    """
    service = MessageService(db)
...
def get_messaging_stats(db: Session = Depends(get_db_sync_dependency)):
