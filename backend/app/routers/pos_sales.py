...
from app.routers.pos_auth import verify_pos_token
from app.services.pos_service import complete_sale
from app.services.thermal_printer import EscPosReceiptPrinter, MockReceiptPrinter

router = APIRouter(prefix="/pos", tags=["POS Sales"])
