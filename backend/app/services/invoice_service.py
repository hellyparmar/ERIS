...
from app.services.invoice_pdf_service import InvoicePDFGenerator
...
class InvoiceService(OutletIsolatedService):
    ...
    def export_tally_xml(self, invoice_id: int) -> str:
        ...
        return "<ENVELOPE>Not Implemented</ENVELOPE>"

class BillService:
    @staticmethod
    def create_bill(**kwargs):
        return {"success": False, "error": "Not implemented in consolidation"}
    ...
    @staticmethod
    def get_bill_details(bill_id, db):
        return {"success": False, "error": "Not implemented"}

    @staticmethod
    def record_bill_payment(bill_id, **kwargs):
        return {"success": False, "error": "Not implemented"}

    @staticmethod
    def get_vendor_analytics(**kwargs):
        return {"success": True, "data": []}

    @staticmethod
    def get_pending_bills(**kwargs):
        return {"success": True, "data": []}
