...
from app.models.models_v6 import Supplier, PurchaseOrder, PurchaseOrderItem, Product
...
class SupplierService(OutletIsolatedService):
    ...
    def update_po_status(self, po_id: int, status: str, notes: Optional[str] = None) -> PurchaseOrder:
    ...
    def receive_goods(self, po_id: int, received_items: list, notes: Optional[str] = None) -> PurchaseOrder:
