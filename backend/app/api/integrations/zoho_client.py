...
class ZohoClient:
    ...
    def __init__(self, auth_service: ZohoAuthService, organization_id: str, mock_mode: bool = False):
    ...
    async def get_items(self, page: int = 1, per_page: int = 200) -> Dict[str, Any]:
        ...
        if self.mock_mode:
            return {
                "items": [{"item_id": "1", "name": "Mock Item", "rate": 100}],
                "page_context": {"page": page, "per_page": per_page, "has_more_page": False},
                "total": 1
            }
    ...
    async def test_connection(self) -> Dict[str, Any]:
        ...
        if self.mock_mode:
            return {
                "connected": True,
                "organizations": [{"organization_id": self.organization_id, "name": "Mock Org"}],
