...
from sqlalchemy import func, desc, or_, and_, select, case
from uuid import UUID

from app.database import get_db
from app.models import User, Outlet, BusinessContact, Invoice
...
async def get_contact(
    ...
    response.invoice_history = InvoiceHistorySummary(
        ...
        last_invoice_date=last_invoice.created_at if last_invoice else None
    )
