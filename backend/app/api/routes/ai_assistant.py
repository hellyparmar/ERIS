...
async def chat(request: ChatRequest):
    ...
    try:
        ...
        from app.api.services.semantic_layer import semantic_layer
        from app.api.services.query_executor import query_executor
        ...
        if not template_match:
            from app.api.services.dynamic_query_generator import dynamic_query_generator
