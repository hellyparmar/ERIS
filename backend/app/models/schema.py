...
from sqlalchemy import (
    Column, Integer, String, Boolean, DateTime, ForeignKey, Text, Numeric, 
    Float, Date, Time, Enum as SQLEnum, Table, UniqueConstraint, Index,
...
class AuditLog(Base):
    ...
    # Change details
    entity_type = Column(String(100), nullable=False)  # e.g., 'Product', 'Sale'
