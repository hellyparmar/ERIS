...
# We re-export it here so other modules can import it from app.api.db.models
# Product, Customer, Supplier models are imported from multitenant_models

from app.models.multitenant_models import User, UserRole, Product, Customer, Supplier, Invoice, PaymentStatus, Inventory, PurchaseOrder, PurchaseOrderItem
...
class Sale(Base):
    ...
    store_id = Column(UUID(as_uuid=True), index=True)
