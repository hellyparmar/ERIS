...
from app.models.invoicing import Invoice as _CanonicalInvoice

# Re-export canonical Invoice to avoid duplicate class registration
Invoice = _CanonicalInvoice
